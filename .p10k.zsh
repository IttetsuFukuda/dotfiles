# Generated by Powerlevel10k configuration wizard on 2023-08-11 at 13:42 JST.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='%45F${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_CLUSTER}}'
  # Append the current context's namespace if it's not "default".
  # POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='%248F|%46F${${:-$P9K_KUBECONTEXT_NAMESPACE}:#default}'

  # PROD
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=33
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION=
  POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION+='%196F${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_CLUSTER}}'
